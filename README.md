...
- 🎯 Passionate about **frontend**, **education tools**, and **Minecraft creativity**
...
- 📊 Data tools, Vue apps, and custom dev scripts (more coming...)

### 📚 Learning & Interests

- 🔍 Vue 3 + Vite + Ant Design Vue  
- 🕹 Minecraft modding / map tools  
- 🔬 Exploring AIGC-generated UI workflows  
- 📘 Writing dev blogs and design articles

---

## 🧱 Minecraft Developer Vibe
...
> _Yes, I turned a creeper into a homework reminder once._
...
- 🧨 曾用 Creeper 做提醒器
- 📦 喜欢收集冷门但实用的 VSCode 插件
- 🌌 喜欢写 `console.log()` 胜于调试
- 🧱 还在做红石机关，永远不嫌旧
